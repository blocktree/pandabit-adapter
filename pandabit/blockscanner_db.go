...
func (bs *PBBlockScanner) SaveLocalBlockHead(blockHeight uint32, blockHash string) error {
...
func (bs *PBBlockScanner) GetLocalBlockHead() (uint32, string, error) {
...
func (bs *PBBlockScanner) SaveLocalBlock(blockHeader *Block) error {
...
func (bs *PBBlockScanner) GetLocalBlock(height uint32) (*Block, error) {
...
func (bs *PBBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
func (bs *PBBlockScanner) DeleteUnscanRecord(height uint32) error {
...
func (bs *PBBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
