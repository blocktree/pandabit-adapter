...
//PBBlockScanner atom的区块链扫描器
type PBBlockScanner struct {
...
//NewPBBlockScanner 创建区块链扫描器
func NewPBBlockScanner(wm *WalletManager) *PBBlockScanner {
	bs := PBBlockScanner{
...
func (bs *PBBlockScanner) SetRescanBlockHeight(height uint64) error {
	height = height - 1
	if height < 0 {
...
//ScanBlockTask 扫描任务
func (bs *PBBlockScanner) ScanBlockTask() {
...
//ScanBlock 扫描指定高度区块
func (bs *PBBlockScanner) ScanBlock(height uint64) error {
...
func (bs *PBBlockScanner) scanBlock(height uint64) (*Block, error) {
...
func (bs *PBBlockScanner) ScanTxMemPool() {
...
func (bs *PBBlockScanner) RescanFailedRecord() {
...
func (bs *PBBlockScanner) newBlockNotify(block *Block, isFork bool) {
...
func (bs *PBBlockScanner) BatchExtractTransaction(blockHeight uint64, blockHash string, txs []string, memPool bool) error {
...
func (bs *PBBlockScanner) extractRuntime(producer chan ExtractResult, worker chan ExtractResult, quit chan struct{}) {
...
func (bs *PBBlockScanner) ExtractTransaction(blockHeight uint64, blockHash string, txid string, scanAddressFunc openwallet.BlockScanAddressFunc, memPool bool) ExtractResult {
...
func (bs *PBBlockScanner) newExtractDataNotify(height uint64, extractData map[string]*openwallet.TxExtractData) error {
...
func (bs *PBBlockScanner) DeleteUnscanRecordNotFindTX() error {
...
func (bs *PBBlockScanner) GetCurrentBlockHeader() (*openwallet.BlockHeader, error) {
	var (
...
func (bs *PBBlockScanner) GetScannedBlockHeader() (*openwallet.BlockHeader, error) {
	...
	if blockHeight == 0 {
		blockHeight, err = bs.wm.GetBlockHeight()
		if err != nil {
			bs.wm.Log.Errorf("PB GetBlockHeight failed,err = %v", err)
			return nil, err
		}
...
func (bs *PBBlockScanner) GetScannedBlockHeight() uint64 {
	localHeight, _, _ := bs.wm.Blockscanner.GetLocalNewBlock()
	return localHeight
}

func (bs *PBBlockScanner) ExtractTransactionData(txid string, scanTargetFunc openwallet.BlockScanTargetFunc) (map[string][]*openwallet.TxExtractData, error) {
...
func (bs *PBBlockScanner) GetSourceKeyByAddress(address string) (string, bool) {
	bs.Mu.RLock()
	defer bs.Mu.RUnlock()
...
func (bs *PBBlockScanner) GetLocalNewBlock() (uint64, string, error) {
...
func (bs *PBBlockScanner) SaveLocalNewBlock(blockHeight uint64, blockHash string) error {
...
func (bs *PBBlockScanner) GetTransactionsByAddress(offset, limit int, coin openwallet.Coin, address ...string) ([]*openwallet.TxExtractData, error) {
...
//Run 运行
func (bs *PBBlockScanner) Run() error {
...
////Stop 停止扫描
func (bs *PBBlockScanner) Stop() error {
...
//Pause 暂停扫描
func (bs *PBBlockScanner) Pause() error {
...
//Restart 继续扫描
func (bs *PBBlockScanner) Restart() error {
...
func (bs *PBBlockScanner) setupSocketIO() error {
...
//@optional
func (bs *PBBlockScanner) SupportBlockchainDAI() bool {
	return true
}
