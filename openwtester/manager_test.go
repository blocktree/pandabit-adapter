...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO PB", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WL9k17NSynCvLr5MHgPevs7coNFiHUmspe")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WL9k17NSynCvLr5MHgPevs7coNFiHUmspe"
	account := &openwallet.AssetsAccount{Alias: "HELLO PB", WalletID: walletID, Required: 1, Symbol: "PB", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WL9k17NSynCvLr5MHgPevs7coNFiHUmspe"
	accountID := "ARQHkEa9f7C6yhcwFUxrT7CzCRg2JRgCSub3E8adPikb"
