...
func TestTransfer(t *testing.T) {
	...
	to := "cosmos1nu85cns5rrv6x8g2gy9fqlkdppctw87x9cd8mz"
...
func getdata(addr string) {
	c := pandabit.NewClient("http://47.112.139.225:20001", false)
...
func TestSummary(t *testing.T) {
	...
	summaryAddress := "pandabit1xv66sa5tlplm68j4fec6stdzszg3pcvswag06j"
